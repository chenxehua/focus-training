...
('schulte', '舒尔特方格', '在N×N方格中按顺序点击1-N数字，训练视觉搜索效率和注意力稳定性', '注意力', 5, '视觉搜索,持续注意,广度', 0, 1),
('audio_count', '听声辨数', '仔细听系统播放的声音序列，选择听到的数量，训练听觉注意力和反应速度', '听觉', 5, '听觉注意,工作记忆,反应速度', 0, 2),
('pattern_memory', '图案记忆', '记住并匹配不同的图案组合，训练视觉记忆和模式识别能力', '记忆', 5, '视觉记忆,模式识别,工作记忆', 0, 3),
('visual_tracking', '视觉追踪', '追踪移动的目标同时忽略干扰物，训练视觉追踪和持续注意力', '注意力', 5, '视觉追踪,持续注意,抗干扰', 0, 4),
('rhythm_tap', '节奏点击', '听到指定节奏时点击，其他时候不点，训练警觉网络和反应抑制能力', '感知', 5, '警觉网络,反应抑制,持续注意力', 1, 5),
('auditory_memory', '听觉记忆', '听口令后按顺序或倒序复述数字，训练听觉工作记忆和顺序记忆', '记忆', 5, '听觉工作记忆,顺序记忆,倒序回忆', 1, 6),
('maze_navigation', '迷宫寻路', '在迷宫中找到从起点到终点的路径，训练空间认知和执行功能', '观察', 5, '空间认知,执行功能,持续性注意', 1, 7),
('quick_sort', '快速分类', '根据规则快速将物品分类，规则会切换，训练认知灵活性和注意力转移', '计算', 5, '认知灵活性,注意力转移,反应抑制', 1, 8),
('target_tracking', '追踪目标', '在复杂场景中找到并追踪目标，出现变化时点击，训练选择性注意和抗干扰能力', '注意力', 5, '选择性注意,视觉搜索效率,抗干扰', 1, 9);
