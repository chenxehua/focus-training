...
- Name: e2e.spec.ts >> 专注星球 - 端到端测试 >> 首页功能 >> 游戏列表加载
- Location: tests/e2e.spec.ts:38:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/pages/games/index
Call log:
  - navigating to "http://localhost:5173/pages/games/index", waiting until "load"
