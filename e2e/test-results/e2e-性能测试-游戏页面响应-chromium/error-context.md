...
- Name: e2e.spec.ts >> 性能测试 >> 游戏页面响应
- Location: tests/e2e.spec.ts:277:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/pages/game-schulte/index
Call log:
  - navigating to "http://localhost:5173/pages/game-schulte/index", waiting until "load"
